...
public class Report {
    ...
    static void reportHostsGT10P(Scanner scanner, Statement stmt) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
                ...
                System.out.println("Choose an option:");
                System.out.println("1: Report number of bookings");                                         // Half done
                System.out.println("2: Report total number of listings");
                System.out.println("3: Report hosts by number of listings");
                System.out.println("4: Report hosts that have >10% of listings in a city or country");      // TODO
                System.out.println("5: Report renters by number of bookings");                              // Half done
                System.out.println("6: Report renters by number of bookings (later report)");               // TODO
                System.out.println("7: Report hosts and renters with the most cancellations within a year");
                System.out.println("8: Report popular noun phrases in comments");                           // TODO
